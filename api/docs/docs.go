        ...
        "/api/order/get_all": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by order item name",
                        "name": "quantity",
                        "in": "query"
                    },
                    {
        ...
        "/api/reservation/get_all": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by menu item user_id",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by restaurant reservation_time",
                        "name": "reservation_time",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by restaurant restaurant_id",
                        "name": "restaurant_id",
                        "in": "query"
                    },
                    {
