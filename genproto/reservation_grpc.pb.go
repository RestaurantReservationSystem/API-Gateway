...
const (
	...
	ReservationService_CreateOrder_FullMethodName        = "/protos.ReservationService/CreateOrder"
	ReservationService_UpdateOrder_FullMethodName        = "/protos.ReservationService/UpdateOrder"
	ReservationService_DeleteOrder_FullMethodName        = "/protos.ReservationService/DeleteOrder"
	ReservationService_GetByIdOrder_FullMethodName       = "/protos.ReservationService/GetByIdOrder"
	ReservationService_GetAllOrder_FullMethodName        = "/protos.ReservationService/GetAllOrder"
	ReservationService_CreateRestaurant_FullMethodName   = "/protos.ReservationService/CreateRestaurant"
	ReservationService_GetByIdRestaurant_FullMethodName  = "/protos.ReservationService/GetByIdRestaurant"
	ReservationService_GetAllRestaurants_FullMethodName  = "/protos.ReservationService/GetAllRestaurants"
	ReservationService_UpdateRestaurant_FullMethodName   = "/protos.ReservationService/UpdateRestaurant"
	ReservationService_DeleteRestaurant_FullMethodName   = "/protos.ReservationService/DeleteRestaurant"
	ReservationService_CreateMenu_FullMethodName         = "/protos.ReservationService/CreateMenu"
	ReservationService_UpdateMenu_FullMethodName         = "/protos.ReservationService/UpdateMenu"
	ReservationService_DeleteMenu_FullMethodName         = "/protos.ReservationService/DeleteMenu"
	ReservationService_GetByIdMenu_FullMethodName        = "/protos.ReservationService/GetByIdMenu"
	ReservationService_GetAllMenu_FullMethodName         = "/protos.ReservationService/GetAllMenu"
)
...
func (c *reservationServiceClient) CreateOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationService_CreateOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) UpdateOrder(ctx context.Context, in *UpdateOrderRequest, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationService_UpdateOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) DeleteOrder(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationService_DeleteOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetByIdOrder(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetByIdOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetAllOrder(ctx context.Context, in *GetAllOrderRequest, opts ...grpc.CallOption) (*OrdersResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetAllOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetByIdRestaurant(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*RestaurantResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetByIdRestaurant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) CreateMenu(ctx context.Context, in *CreateMenuRequest, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
	err := c.cc.Invoke(ctx, ReservationService_CreateMenu_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetByIdMenu(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*MenuResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetByIdMenu_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) GetAllMenu(ctx context.Context, in *GetAllMenuRequest, opts ...grpc.CallOption) (*MenusResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_GetAllMenu_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReservationService_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_CreateOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_UpdateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_UpdateOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_DeleteOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_DeleteOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_GetByIdOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetByIdOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_GetAllOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetAllOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_GetByIdRestaurant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetByIdRestaurant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_CreateMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_CreateMenu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_GetByIdMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetByIdMenu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReservationService_GetAllMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetAllMenu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
